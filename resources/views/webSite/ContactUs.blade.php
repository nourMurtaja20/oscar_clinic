    ...
    <div class="s3-2">
        <form class="contact-form" method="post" action="{{route('contact.send.mail')}}">
            ...
            <div class="formbox">
                ...
                <textarea class="textarea1-contactUs" placeholder="قم بادخال الرسالة" name="messageText"></textarea>
            </div>
            <div class="formbox">
                <button type="submit" class="bookNow">ارسال</button>
            </div>
        </form>
    </div>
    <div class="s3-3">
