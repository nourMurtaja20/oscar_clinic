    ...
    <div class="row">
        <div class="card-body">
            ...
            <div class="section2-appointment">
                <div class="s2-1">
                    <h2 class="h3">قم بحجز موعد اون لاين الأن</h2>
                ...
                <div class="s2-2">
                    <div class="s2-3">
                        <h2 class="h4">حجز موعد</h2>
                        <div class="s2-4">
                            <img src="{{ asset('assets/images/vector.png')}}" class="img1">
                            <h2 class="h5" onclick="Functionopen() ">قبل حجز موعد</h2>
                        </div>
                    </div>
                    ...
                    <div class="s2-5">
                        <form action="{{route ('webSite.bookAppointment.store')}}" method="get">
                            <div class="formbox">
                                <label class="h6" style="top:170px; margin-bottom:16px;">وقت الحجز</label>
                                <input type="datetime-local" class="select1"
                                       placeholder="تاريخ الموعد"
                                       value="" name="start" id="datetimepicker2"/>
                            </div>
                            {{--<div class="formbox">--}}
                                {{--<label class="h6">الأخصائي المسؤول </label>--}}
                            ...
                            {{--</div>--}}
                            <div class="formbox">
                                <label class="h6" style="margin-bottom:16px;">نوع الحجز</label>
                            ...
                            <div class="formbox">
                                <label class="h6" style="top:500px;">حالات خاصة </label>
