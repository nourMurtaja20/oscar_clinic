...
@section('content')
                            ...
                            @foreach ($pateints as $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form method="POST" action="{{route ('Reciption.Patient.delete',$item->id)}}"
            ...
            <div class="modal fade" id="showPatientInformation_{{$pateint->id}}" tabindex="-1" role="dialog"
                ...
                margin-left: 0px;">
                    ...
                    margin-left: 0px;">
                                ...
                                <div class="form-group row " style="
                    margin-left: 0px;">
                                    <label class="col-lg-auto col-form-label text-left" style="margin-left: 17px;">:
                                        Address </label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control"
            ...
            <div class="modal fade" id="EditPatientInformation_{{$pateint->id}}" tabindex="-1" role="dialog"
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    ...
                    margin-right: 0px;">
                        ...
                        <div class="modal-body">
                            <form action="{{route ('Reciption.Patient.update',$pateint->id)}}" method="get">
                                <div class="card-body">
                                    <div class="form-group row " style="
                    margin-left: 0px;">
                                        <label class="col-lg-auto col-form-label text-right">:
                ...
                margin-left: 0px;">
                                    ...
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control"
                                               placeholder="عنوان سكن المريض"
                                               value="{{$pateint->addres}}" name="addres" style="margin-left: 40px;"/>
                                    </div>
    ...
    <!--start: modal for Add patient -->
        <div class="modal fade" id="PatientAdd" tabindex="-1" role="dialog" aria-labelledby="exampleModalSizeLg"
             aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="{{route ('admin.patients.store')}}" method="get" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group row ">
                                    <label class="col-lg-auto col-form-label text-left" style="margin-left: 184px;
                                                margin-top: -20px;"> Patient Name </label>
                                    <div class="col-lg-9">
                                        <input style="margin-left: 370px;width: 400px;margin-top: -44px;"
                                               type="text" class="form-control" placeholder="اسم المريض" value=""
                                               name="name"/>
                                    </div>
                                ...
                                <div class="form-group row ">
                                    <label class="col-lg-auto col-form-label text-left"
                                        ...
                                        Patient Email </label>
                                    <div class="col-lg-9">
                                        <input style="margin-left: 370px;
                                    width: 400px;margin-top: -51px;" type="text" class="form-control"
                                               placeholder="البريد الإلكتروني " value="" name="email"/>
                                    </div>

                                </div>
                                {{--<div class="form-group row ">--}}
                                    {{--<label class="col-lg-auto col-form-label text-left" style="margin-left: 199px;--}}
                                {{--margin-top: 5px;padding-left: 0px;"> Patient password </label>--}}
                                    {{--<div class="col-lg-9">--}}
                                        {{--<input style="margin-left: 370px;--}}
                                {{--width: 400px;margin-top: -51px;" type="text" class="form-control"--}}
                                               {{--placeholder="كلمة المرور " value="" name="PatientPassword"/>--}}
                                    {{--</div>--}}

                                {{--</div>--}}
                                <div class="form-group row ">
                                    <label class="col-lg-auto col-form-label text-left" style="margin-left: 199px;
                            margin-top: 13px;padding-left: 0px;">Data Of Birth</label>
                                    <div class="col-lg-9">
                                        <input style="margin-left: 370px;
                                width: 400px;margin-top: -44px;" type="date" class="form-control"
                                ...
                                <div class="form-group row ">
                                    <label class="col-lg-auto col-form-label text-left" style="margin-left: 199px;
                                    margin-top: 15px;padding-left: 0px;"> Patient Address</label>
                                    <div class="col-lg-9">
                                        <input style="margin-left: 370px;
                            width: 400px;margin-top: -44px;" type="text" class="form-control" placeholder="عنوان السكن "
                                               value="" name="addres"/>
                                    </div>
                                ...
                                <div class="form-group row ">
                                    <label class="col-lg-auto col-form-label text-left" style="margin-left: 199px;
                                     margin-top: 15px;padding-left: 0px;"> Patient Phone</label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control" placeholder="رقم الجوال "
                                               value="" style="margin-left: 370px;
                                        width: 400px;margin-top: -44px;" name="phone"/>
                                    </div>

                                </div>
                                <div class="form-group row ">
                                    <label class="col-lg-auto col-form-label text-left" style="    margin-left: 195px;
                                     margin-top: 20px; padding-left: 0px;" class="gender" for="gender">
                                        Patient Gender</label>
                                    <div class="col-lg-9" style="    margin-top: -27px;
                                        display: inherit; margin-left: 387px;">
                                        <input type="radio" name="gender" value="0" class="gendermale">
                                        <label for="html" for="html" class="Lgendermale">male</label>

                                        <input type="radio" name="gender" style="margin-left: 20px;"
                                               value="1" class="genderfemale">
                                        <label for="html" class="Lgenderfemale">female</label>
                                    </div>
                                </div>
                                <div class="form-group row ">
                                    <label class="col-lg-auto col-form-label text-left"
                                           style="margin-left: 180px;  margin-top: 20px;">
                                        Patient Chronic Diseases</label>
                                    <div class="col-lg-9">
                                ...
                                <div class="card-footer" style="margin-top: 31px;margin-left: -6px;">
