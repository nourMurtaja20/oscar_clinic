                        ...
                        <table class="table" id="dataTable">
                            ...
                            @foreach($Appointments as$appointment)
                                <tr>
                                    ...
                                    <form method="POST"
                                              action="{{route ('Admin.Appointment.delete',$appointment->id)}}"
                            ...
                            margin-top: 13px;padding-left: 0px;">Data and Start Time</label>
                                    <div class="col-lg-9">
                                        ...
                                        margin-left: 366px;width: 405px;margin-top: -40px;"
                                               ...
                                               value="" name="start" id="datetimepicker" style=" margin-left: 245px;
;"/>
                                    </div>
                                ...
                                <div class="form-group row ">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control" id="Service" name="Service"
                                            ...
                                            <option selected></option>
                                            @foreach($services as $service)
                                                @if($service->title=='تقويم أسنان')
                                                    <option name="Service"
                                                            value="{{$service->id}}" selected>{{$service->title}}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
...
;"/>
        ...
        @foreach($Appointments as $appointment)
            <div class="modal fade" id="EditappointmentInformation_{{$appointment->id}}" tabindex="-1" role="dialog"
                 aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel"> Appointment Page</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-right: 1px;">
                                <i aria-hidden="true" class="ki ki-close"></i>
                            </button>
                        </div>
                        <div class="modal-body">
                            ...
                            <p class="card-text">patient name :
                                ...
                                @foreach($appointment->services as $service)
                                    <p class="card-text">Service Name :
                                        <input type="text" name="name" value="{{$service->title}}" class="form-control">
                                ...
                                <p class="card-text">Date :
                                    <input type="text" name="name"
                                           value="{{date('d-m-Y', strtotime($appointment->start))}}" class="form-control"> 
                                </p>
                                <div class="separator separator-dashed my-5"></div>
                                <div class="separator separator-dashed my-5"></div>
                                <p class="card-text">Time :
                                    <input type="text" name="name"
                                           value="{{date('h:s', strtotime($appointment->start))}}" class="form-control">
