                                ...
                                <tr>
                                    <td>{{ $loop->iteration }}</td>
                                            ...
                                            <td>
                                                ...
                                                <form method="POST" action="{{route ('admin.Doctre.delete',$item->id)}}"
...
">
    ...
    margin-left: 0px;">
                                        ...
                                        @elseif($doctor->specialization ==1)
                                            <input type="text" class="form-control"
                                                   placeholder="تخصص الدكتور" style="
    margin-left: 132px;
    margin-top: -37px;
    margin-right: 78px;
"
                                        ...
                                        @elseif($doctor->specialization ==2)
                                            <input style="margin-left: 135px;margin-top: -35px;margin-right: 80px;" type="text" class="form-control"
                                                   placeholder="تخصص الدكتور"
                                                   value="تقويم أسنان" name="specialization" disabled="true"/>

                                        @endif
                                    </div>
                                    <div class="m-form__group form-group" style="margin-left: 0px;">
                                        <label for="" style="margin-left: 15px;">Working days</label>
                                        <div class="m-checkbox-inline"style="
    margin-left: 130px;
    margin-top: -20px;
"> 
...
">
                        ...
                        <div class="modal-body">
                            <form action="{{route ('admin.Doctre.update',$doctor->id)}}" method="get">
    ...
    margin-top: -20px;
">
                                            @if($doctor->TimeForWork=='Saturday')
                                                <label class="m-checkbox">
                                            ...
                                            @elseif($doctor->TimeForWork=='Sunday - Monday - Tuesday - Wednesday-  Thursday')
                                                <label class="m-checkbox">
