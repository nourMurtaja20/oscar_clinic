    ...
    <div class="page-wrapper">
        <div class="section11">
            ...
            <div class="hero-box">
                ...
                <a class="booknow" href="/Patient/bookAppointment">احجز موعد الان</a>
            </div>
        </div>

        <div class="section2-services">
            <h3 class="h3-s">نقوم بتقديم الأفضل لمرضنا</h3>
        ...
        <div class="section3-services">
            <h3 class="h3-s">الخدمات التي تقدمها العيادة</h3>
            <p class="p2">لسنا مجرد مركز لعلاج الأسنان فحسب، بل لدينا من نفخر بهم من أطباء الأسنان لماهرين تأهيلاً
                وخبرةً،
                يتلقون شهادات الدكتوراه؛ من أجل راحتكم</p>
        </div>
