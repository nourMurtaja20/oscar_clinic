...
class AppointmentController extends Controller
{
    ...
    public function index ()
    {
        ...
        return view ('Systems.Admin.Appointment',compact ('users'))->with ('Appointments', $Appointments)->with ('services', $services)->with ('patients', $patients);
    }
...
//            dd($service);
    ...
    public function update (Request $request, $id)
    {
        ...
        Note::create ([
            'noteText' => $request->input ('oteText'),
